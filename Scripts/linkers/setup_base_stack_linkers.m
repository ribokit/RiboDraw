...
for i = 1:length( base_stacks )
    ...
    res_tag1 = sprintf('Residue_%s%d',base_stack.chain1,base_stack.resnum1);
    res_tag2 = sprintf('Residue_%s%d',base_stack.chain2,base_stack.resnum2);
    clear linker
    ...
    linker.type = 'stack';
    linker_tag = sprintf('Linker_%s%d_%s%d_%s', base_stack.chain1,base_stack.resnum1,base_stack.chain2,base_stack.resnum2,linker.type);
