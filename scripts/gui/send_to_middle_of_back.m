function send_to_middle_of_back( h  )
% send_to_back( handle )
%
...
%
%  That is, the handle will move behind all elements except the ones that were sent to back. This is kind of just under the middle layer.
%
