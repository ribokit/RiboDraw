function tertiary_contact = update_tertiary_contact_name( tertiary_contact, print_stuff )
% update_tertiary_contact_names( tertiary_contact, print_stuff )
% 
...
if ~exist( 'tertiary_contact','var' );  tertiary_contact = get_tags( 'Tertiary' ); end;
if iscell( tertiary_contact ) 
    for i = 1:length(tertiary_contact)
        tertiary_contact =  update_tertiary_contact_name( tertiary_contact{i}, print_stuff ); 
    end;
    return
end
if ischar( tertiary_contact ); tertiary_contact = getappdata( gca, tertiary_contact ); end;
...
if length( name1 ) == 0; return; end;
if length( name2 ) == 0; return; end;
...
if print_stuff; fprintf( 'Setting tertiary contact name %s for contact %s\n', tertiary_contact.name,tertiary_contact.tertiary_contact_tag ); end;
setappdata( gca, tertiary_contact.tertiary_contact_tag, tertiary_contact );
